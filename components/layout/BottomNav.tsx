...
export const BottomNav: React.FC = () => {
  const navItems = [
    ...
    },
    {
      ...
      label: 'Staff',
      icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h2a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v11a2 2 0 002 2h2m0 0l4-4m-4 4l-4-4m4 4v-4m-6 4h16"></path></svg>
    },
    {
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex flex-col items-center justify-center w-full h-full space-y-1 ${
                isActive ? 'text-offoOrange' : 'text-gray-400 hover:text-gray-600'
              }`
            }
          >
            {item.icon}
