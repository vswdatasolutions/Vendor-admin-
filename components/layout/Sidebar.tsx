...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, onLogout }) => {
  ...
  const navLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L20 16m-2 0l2-2m-6.5-6.5L12 10.5m-2.5 2.5L7 10.5M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
      ),
    },
    {
      name: 'Settings',
